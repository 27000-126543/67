...
export const PLANT_SPECIES: PlantSpecies[] = [
  { id: 'fire_flower', name: '火焰花', description: '散发温暖的魔法花朵', element: 'fire', growthTime: 5000, fruitYield: 2, fruitType: 'fire_fruit', attractsSpirits: ['flame_wisp'], attractionBonus: 1.5, rarityBonus: 1.1, cost: 50, sprite: '🌺' },
  { id: 'water_lily', name: '水莲', description: '漂浮在魔法水面上的莲花', element: 'water', growthTime: 5000, fruitYield: 2, fruitType: 'water_fruit', attractsSpirits: ['aqua_sprite'], attractionBonus: 1.5, rarityBonus: 1.1, cost: 50, sprite: '🪷' },
  { id: 'sunflower', name: '魔法向日葵', description: '追踪阳光的金黄花朵', element: 'grass', growthTime: 4000, fruitYield: 3, fruitType: 'grass_fruit', attractsSpirits: ['leaf_fairy'], attractionBonus: 1.4, rarityBonus: 1.1, cost: 40, sprite: '🌻' },
  { id: 'green_vine', name: '翠绿藤蔓', description: '快速生长的魔法藤蔓', element: 'grass', growthTime: 3000, fruitYield: 2, fruitType: 'grass_fruit', attractsSpirits: ['leaf_fairy'], attractionBonus: 1.3, rarityBonus: 1.0, cost: 30, sprite: '🌱' },
  { id: 'thunder_plant', name: '雷电草', description: '带静电的神奇植物', element: 'thunder', growthTime: 6000, fruitYield: 2, fruitType: 'thunder_fruit', attractsSpirits: ['spark_mouse'], attractionBonus: 1.5, rarityBonus: 1.15, cost: 60, sprite: '🌵' },
  { id: 'light_flower', name: '光绽花', description: '在黑暗中发光的花朵', element: 'light', growthTime: 8000, fruitYield: 1, fruitType: 'light_fruit', attractsSpirits: ['light_spirit'], attractionBonus: 1.6, rarityBonus: 1.25, cost: 120, sprite: '🌸' },
  { id: 'dark_rose', name: '暗影玫瑰', description: '吸收光线的神秘玫瑰', element: 'dark', growthTime: 8000, fruitYield: 1, fruitType: 'dark_fruit', attractsSpirits: ['shadow_cat'], attractionBonus: 1.6, rarityBonus: 1.25, cost: 120, sprite: '🥀' },
  { id: 'wind_flower', name: '风信子', description: '随风摇曳的魔法花朵', element: 'wind', growthTime: 5000, fruitYield: 2, fruitType: 'wind_fruit', attractsSpirits: ['wind_bird'], attractionBonus: 1.5, rarityBonus: 1.1, cost: 55, sprite: '💐' },
  { id: 'stone_fruit', name: '石果树', description: '结出坚硬果实的树', element: 'earth', growthTime: 7000, fruitYield: 2, fruitType: 'earth_fruit', attractsSpirits: ['rock_golem'], attractionBonus: 1.5, rarityBonus: 1.2, cost: 80, sprite: '🌳' },
  { id: 'ember_rose', name: '余烬蔷薇', description: '稀有火焰蔷薇', element: 'fire', growthTime: 10000, fruitYield: 1, fruitType: 'fire_fruit', attractsSpirits: ['flame_wisp', 'phoenix_chick', 'dragon_whelp'], attractionBonus: 2.0, rarityBonus: 1.5, cost: 300, sprite: '🌹' },
  { id: 'blue_bloom', name: '碧蓝花苞', description: '深海绽放的稀有花朵', element: 'water', growthTime: 10000, fruitYield: 1, fruitType: 'water_fruit', attractsSpirits: ['aqua_sprite'], attractionBonus: 2.0, rarityBonus: 1.4, cost: 250, sprite: '💎' },
  { id: 'static_bloom', name: '静电磁花', description: '雷电属性稀有花朵', element: 'thunder', growthTime: 10000, fruitYield: 1, fruitType: 'thunder_fruit', attractsSpirits: ['spark_mouse', 'dragon_whelp'], attractionBonus: 1.9, rarityBonus: 1.45, cost: 280, sprite: '💠' },
  { id: 'sacred_bloom', name: '圣辉花', description: '神圣属性的传说之花', element: 'light', growthTime: 12000, fruitYield: 1, fruitType: 'light_fruit', attractsSpirits: ['light_spirit', 'celestial_stag'], attractionBonus: 2.5, rarityBonus: 2.0, cost: 800, sprite: '🌟' },
  { id: 'void_mushroom', name: '虚空蘑菇', description: '来自虚空的神秘蘑菇', element: 'dark', growthTime: 11000, fruitYield: 1, fruitType: 'dark_fruit', attractsSpirits: ['shadow_cat'], attractionBonus: 2.2, rarityBonus: 1.7, cost: 500, sprite: '🍄' },
  { id: 'sky_herb', name: '天空草药', description: '只在高空生长的草药', element: 'wind', growthTime: 8000, fruitYield: 2, fruitType: 'wind_fruit', attractsSpirits: ['wind_bird'], attractionBonus: 1.8, rarityBonus: 1.3, cost: 180, sprite: '☁️' },
  { id: 'earth_root', name: '大地之根', description: '深入地底的古老根系', element: 'earth', growthTime: 10000, fruitYield: 1, fruitType: 'earth_fruit', attractsSpirits: ['rock_golem'], attractionBonus: 1.9, rarityBonus: 1.4, cost: 220, sprite: '🪨' },
  { id: 'phoenix_feather_plant', name: '凤凰羽草', description: '如凤凰羽毛般的神草', element: 'fire', growthTime: 15000, fruitYield: 1, fruitType: 'fire_fruit', attractsSpirits: ['phoenix_chick', 'dragon_whelp'], attractionBonus: 3.0, rarityBonus: 2.5, cost: 1500, sprite: '🪶' },
  { id: 'dragon_scale_plant', name: '龙鳞蕨', description: '如龙鳞般的远古蕨类', element: 'fire', growthTime: 18000, fruitYield: 1, fruitType: 'fire_fruit', attractsSpirits: ['dragon_whelp'], attractionBonus: 3.5, rarityBonus: 3.0, cost: 3000, sprite: '🐲' },
  { id: 'starlight_orchid', name: '星光兰花', description: '星辰之力凝聚的兰花', element: 'light', growthTime: 20000, fruitYield: 1, fruitType: 'light_fruit', attractsSpirits: ['celestial_stag'], attractionBonus: 4.0, rarityBonus: 3.5, cost: 5000, sprite: '🌠' },
];
